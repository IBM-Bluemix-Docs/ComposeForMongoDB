...
Ces fonctions vous permettent d'adapter votre service {{site.data.keyword.composeForMongoDB}} de sorte qu'il réponde mieux à vos besoins et exigences.
...
![Panneau Version](./images/mongodb-version-show.png "Panneau Version")
...
![Adresses IP mises en liste blanche](./images/mongodb-whitelist-show.png "Zones d'une liste blanche.")
...
Lorsque toutes les entrées d'une liste blanche ont été supprimées, la liste est désactivée et toutes les adresses IP sont acceptées par les portails d'accès TCP ou les portails de routeur Mongos.
